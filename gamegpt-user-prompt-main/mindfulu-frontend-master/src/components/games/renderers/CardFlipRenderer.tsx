...
export const CardFlipRenderer: React.FC<CardFlipRendererProps> = ({
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="lex items-center gap-2 flex-wrap">
                ...
                <div className="relative h-72 mb-4">
                  ...
                  >
                    ...
                    <Card className={`absolute inset-0 border-2 backface-hidden rotate-y-180 ${
                      ...
                      <CardHeader className="pb-0 pt-3">
                        <div className="flex items-center justify-between">
                          <RefreshCw className="w-4 h-0 text-muted-foreground" />
                          {card.category && (
                            <Badge variant="outline" className="text-xs">
                              {card.category}
                            </Badge>
                      ...
                      <CardContent className="p-4 pt-0 h-full flex flex-col justify-center">
                        <div className="text-center flex-1 flex flex-col justify-center">
                          <h4 className="font-semibold text-sm mb-2 text-muted-foreground">Answer:</h4>
      ...
      {isComplete && (
        <Card className={`border-2 ${allCardsViewed() ? 'border-green-500 bg-green-50' : 'border-blue-500 bg-blue-50'}`}>
          <CardContent className="p-5 text-center">
            ...
            <h3 className={`text-xl font-bold mb-2 ${allCardsViewed() ? 'text-green-800' : 'text-blue-800'}`}>
              {allCardsViewed() ? 'All Cards Viewed!' : 'Card Review Complete!'}
            </h3>
            <p className={`mb-3 text-sm ${allCardsViewed() ? 'text-green-700' : 'text-blue-700'}`}>
            ...
            <div className="grid grid-cols-3 gap-3 max-w-sm mx-auto text-sm">
              <div className="bg-white rounded-lg p-2">
                ...
                <div className="text-lg text-primary font-bold">{score}</div>
              </div>
              <div className="bg-white rounded-lg p-2">
                <div className="font-semibold text-xs">Viewed</div>
                <div className="text-lg font-bold">{viewedCards.size}</div>
              </div>
              <div className="bg-white rounded-lg p-2">
                <div className="font-semibold text-xs">Completion</div>
                <div className="text-lg font-bold">{Math.round((viewedCards.size / content.cards.length) * 100)}%</div>
              </div>
            </div>
          </CardContent>
        </Card>
