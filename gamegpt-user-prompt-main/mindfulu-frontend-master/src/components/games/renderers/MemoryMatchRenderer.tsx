...
export const MemoryMatchRenderer: React.FC<MemoryMatchRendererProps> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <Card className="border-2">
        ...
        <CardContent>
          <p className="text-muted-foregroun pt-4">
  ...
  className={`
    relative w-40 min-h-32 cursor-pointer transition-all duration-200
...
>
  ...
  <div
    className={`
      absolute inset-0 w-full min-h-32 rounded-lg border-2 flex items-center justify-center p-3
