...
export const WordPuzzleRenderer: React.FC<WordPuzzleRendererProps> = ({
  ...
  const getCellClassName = (row: number, col: number) => {
    ...
    let className = 'w-8 h-8 border border-border text-center text-sm font-bold cursor-pointer transition-all select-none user-select-none ';
          ...
          <Card className="border-2">
            ...
            <CardContent>
              <div className="flex justify-center">
                <div 
                  className="inline-grid gap-1 p-4 bg-muted rounded-lg select-none"
